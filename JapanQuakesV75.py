...
import numpy as np
import astroThemes
import japanGraphV75
import japanEarthquakerV75
...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        def clickMethod(self):
            ...
            aboutBox.setText("Version 0.70 TESTING\nCreated By: Solid Ground Technologies")
            aboutBox.exec_()
        ...
        def get_recent():
            japanEarthquakerV75.mostRecent()
            japanEarthquakerV75.recentItem.append('Ah')
            recentMessage = "The Most Recent Quake Was At: \n %s" % japanEarthquakerV75.recentItem[0]
        ...
        def japan_count():
            japanEarthquakerV75.japanQuakes()
            japanEarthquakerV75.quakeList.append('argh')
            message1 = "\n{} \n".format(japanEarthquakerV75.quakeList[0])
        ...
        def japan_strengths():
            japanEarthquakerV75.quakeStrengths()
            japanEarthquakerV75.strengthList.append('yo')
            message2 = "\n {} \n".format(japanEarthquakerV75.strengthList[0],)
        ...
        japanGraphV75.get_six()
        japanGraphV75.floatSix.append('Ah')
        japanGraphV75.sixLocations.append('Ah')
        ...
        height = [japanGraphV75.floatSix[0], japanGraphV75.floatSix[1], japanGraphV75.floatSix[2], japanGraphV75.floatSix[3], japanGraphV75.floatSix[4], japanGraphV75.floatSix[5]]
        ...
        def plot():
            ...
            plt.xticks(ind, (japanGraphV75.sixLocations[0], japanGraphV75.sixLocations[1], japanGraphV75.sixLocations[2], japanGraphV75.sixLocations[3], japanGraphV75.sixLocations[4], japanGraphV75.sixLocations[5]))
            #plt.yticks(height)
            #fig, ax = plt.subplots()
        ...
        # x-coordinates
        xItems2 = len(japanGraphV75.prefectureName)
        ind2 = np.arange(xItems2)

        # heights of bars, also the amounts to plot.
        height2 = japanGraphV75.prefectureCounts
        ...
        def get_asia_recent():
                japanEarthquakerV75.mostasiaRecent()
                japanEarthquakerV75.asiarecentList.append('Ah')
                asiarecentMessage = "The Most Recent Quake In Asia Was: \n %s" % japanEarthquakerV75.asiarecentList[0]
        ...
        def asia_get_quakes():
            japanEarthquakerV75.asiaQuakes()
            japanEarthquakerV75.asia_quakeList.append('argh')
            asia_message1 = "\n{} \n".format(japanEarthquakerV75.asia_quakeList[0])
        ...
        def asia_get_strengths():
            japanEarthquakerV75.asiaStrengths()
            japanEarthquakerV75.asia_strengthList.append('argh')
            asia_message2 = "\n {} \n".format(japanEarthquakerV75.asia_strengthList[0])
        ...
        japanGraphV75.get_asia_six()
        japanGraphV75.floatSix.append('Ah')
        japanGraphV75.approvedSix.append('Ah')
        # building the widget for the graph
        self.figure = plt.figure(figsize=(10,5))
        self.canvas = FigureCanvas(self.figure)
        frameLayout.addWidget(self.canvas, 0, 0)
        ...
        # x-coordinates
        xItems2 = len(japanGraphV75.countryName)
        ind2 = np.arange(xItems2)

        # heights of bars, also the amounts to plot.
        height2 = japanGraphV75.countryCounts
        p2 = plt.bar(ind2, height2) #setting the plot
